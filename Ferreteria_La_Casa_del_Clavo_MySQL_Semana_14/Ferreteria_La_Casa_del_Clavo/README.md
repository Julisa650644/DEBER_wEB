...
Edite `.env` con sus propios datos. El programa toma los valores desde las
variables de entorno mediante `python-dotenv`. En PowerShell también puede
cargarlas manualmente antes de iniciar Flask:
